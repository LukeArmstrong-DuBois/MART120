...
function setup() {
    ...
    //Call the Trees
    shape1 = new TrunkLook(200,500,10,55,153,102,0);
    shape2 = new TrunkLook(400,400,10,150,153,102,0);
    shape3 = new TreeTop(210,480,80,30,0,102,0)
    shape4 = new TreeTop(410,385,80,30,0,102,0)

    
   
    // get a random speed when the it first starts
    for (var i = 0; i < 50; i++) {
        shapeXSpeeds[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 3)) + 1);
...
function draw() {
    ...
    drawHouse();
    //House Door
    shape5 = new TrunkLook(50,540,20,40,0,0,0);
